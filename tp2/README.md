...
The parser's job is to process the tokens generated by the lexer, transforming them into a structured representation which can, then, be compiled into machine code.

We weren't able to do this part.
